...
class AboutClassMethods < EdgeCase::Koan
  ...
  #
  # To me, it is more clear to use self.method to avoid confusion, especially if it's a long class.
  # However, there are occasions where it'd be better to use class << self. For instance:
  #
  # class Dave
  #   
  #   @count = 0

...
class Proxy
  attr_reader :messages # return array of messages called
  ...
  def method_missing(method, *args, &block) # based on WellBehavedFooCatcher method, about_message_passing.rb
    @messages << method

...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # I understand that it will never fail.
  ...
  # All regex repetition operators are greedy. They try to match as much as possible in a string.
  ...
  #
  # A character class ([...]) matches a range of characters, and alternation matches specific instances.

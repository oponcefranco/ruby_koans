...
class AboutConstants < EdgeCase::Koan
  ...
  #
  # constants are looked up in the Lexical Scope of the place where 
  # they are used first, and in the inheritance hierarchy second.
  #
  ...
  # you have dropped into the scope of MyAnimals, so ruby knows that LEGS 
  # refers to MyAnimals::LEGS (2) and not Animal::LEGS (4).
end
